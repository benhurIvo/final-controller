 ...
 * 
 */
@WebServiceClient(name = "PeopleService", targetNamespace = "http://ws.final1/", wsdlLocation = "https://damp-mesa-63325.herokuapp.com/ws/people?wsdl")
    ...
    extends Service
{
    ...
    private final static QName PEOPLESERVICE_QNAME = new QName("http://ws.final1/", "PeopleService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://damp-mesa-63325.herokuapp.com/ws/people?wsdl");
    ...
    public People getPeopleImplPort() {
        return super.getPort(new QName("http://ws.final1/", "PeopleImplPort"), People.class);
    }
    ...
    public People getPeopleImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.final1/", "PeopleImplPort"), People.class, features);
    }
